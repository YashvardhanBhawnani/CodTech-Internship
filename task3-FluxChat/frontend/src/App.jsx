...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-100 p-4 font-inter">
      ...
      {/* CHAT WINDOW */}
      {!showNamePopup && (
        <div className="w-full max-w-2xl h-[90vh] bg-zinc-100 rounded-xl shadow-md flex flex-col overflow-hidden">
          {/* CHAT HEADER */}
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
            ...
            <div className="flex-1">
              <div className="text-md font-medium text-[#303030]">
                FluxChat - Realtime group chat
              </div>
